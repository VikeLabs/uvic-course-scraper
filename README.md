...
| Method | Description |
|--------|-------------|
|to do|fill this table in|
|``getClasses()``|Returns an array of ``Course`` objects containing every course|
|``getClass(course tag, course code)``|Returns a ``Course`` object for the given course|
